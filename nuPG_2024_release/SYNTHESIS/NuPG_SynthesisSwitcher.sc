	...
	prMapControls {
		numInstances.do { |i|
			activeSynth.trainInstances[i].setControls([
				...
				modulation_frequency_five: data.data_modulator5[i][1],
				modulation_frequency_six: data.data_modulator6[i][1],
				modulation_frequency_seven: data.data_modulator7[i][1],
				modulation_frequency_eight: data.data_modulator8[i][1],
				...
				modulation_index_five: data.data_modulator5[i][2],
				modulation_index_six: data.data_modulator6[i][2],
				modulation_index_seven: data.data_modulator7[i][2],
				modulation_index_eight: data.data_modulator8[i][2],
				...
				fundamentalMod_five_active: data.data_matrix[i][4][0],
				fundamentalMod_six_active: data.data_matrix[i][5][0],
				fundamentalMod_seven_active: data.data_matrix[i][6][0],
				fundamentalMod_eight_active: data.data_matrix[i][7][0],
				...
				formantOneMod_five_active: data.data_matrix[i][4][1],
				formantOneMod_six_active: data.data_matrix[i][5][1],
				formantOneMod_seven_active: data.data_matrix[i][6][1],
				formantOneMod_eight_active: data.data_matrix[i][7][1],
				...
				formantTwoMod_five_active: data.data_matrix[i][4][2],
				formantTwoMod_six_active: data.data_matrix[i][5][2],
				formantTwoMod_seven_active: data.data_matrix[i][6][2],
				formantTwoMod_eight_active: data.data_matrix[i][7][2],
				...
				formantThreeMod_five_active: data.data_matrix[i][4][3],
				formantThreeMod_six_active: data.data_matrix[i][5][3],
				formantThreeMod_seven_active: data.data_matrix[i][6][3],
				formantThreeMod_eight_active: data.data_matrix[i][7][3],
				// Envelope multiplier modulation (rows 4-6)
				envOneMod_one_active: data.data_matrix[i][0][4],
				envOneMod_two_active: data.data_matrix[i][1][4],
				envOneMod_three_active: data.data_matrix[i][2][4],
				envOneMod_four_active: data.data_matrix[i][3][4],
				envOneMod_five_active: data.data_matrix[i][4][4],
				envOneMod_six_active: data.data_matrix[i][5][4],
				envOneMod_seven_active: data.data_matrix[i][6][4],
				envOneMod_eight_active: data.data_matrix[i][7][4],
				envTwoMod_one_active: data.data_matrix[i][0][5],
				envTwoMod_two_active: data.data_matrix[i][1][5],
				envTwoMod_three_active: data.data_matrix[i][2][5],
				envTwoMod_four_active: data.data_matrix[i][3][5],
				envTwoMod_five_active: data.data_matrix[i][4][5],
				envTwoMod_six_active: data.data_matrix[i][5][5],
				envTwoMod_seven_active: data.data_matrix[i][6][5],
				envTwoMod_eight_active: data.data_matrix[i][7][5],
				envThreeMod_one_active: data.data_matrix[i][0][6],
				envThreeMod_two_active: data.data_matrix[i][1][6],
				envThreeMod_three_active: data.data_matrix[i][2][6],
				envThreeMod_four_active: data.data_matrix[i][3][6],
				envThreeMod_five_active: data.data_matrix[i][4][6],
				envThreeMod_six_active: data.data_matrix[i][5][6],
				envThreeMod_seven_active: data.data_matrix[i][6][6],
				envThreeMod_eight_active: data.data_matrix[i][7][6],
				// Pan modulation (rows 7-9)
				...
				panOneMod_five_active: data.data_matrix[i][4][7],
				panOneMod_six_active: data.data_matrix[i][5][7],
				panOneMod_seven_active: data.data_matrix[i][6][7],
				panOneMod_eight_active: data.data_matrix[i][7][7],
				...
				panTwoMod_five_active: data.data_matrix[i][4][8],
				panTwoMod_six_active: data.data_matrix[i][5][8],
				panTwoMod_seven_active: data.data_matrix[i][6][8],
				panTwoMod_eight_active: data.data_matrix[i][7][8],
				...
				panThreeMod_five_active: data.data_matrix[i][4][9],
				panThreeMod_six_active: data.data_matrix[i][5][9],
				panThreeMod_seven_active: data.data_matrix[i][6][9],
				panThreeMod_eight_active: data.data_matrix[i][7][9],
				...
				ampOneMod_five_active: data.data_matrix[i][4][10],
				ampOneMod_six_active: data.data_matrix[i][5][10],
				ampOneMod_seven_active: data.data_matrix[i][6][10],
				ampOneMod_eight_active: data.data_matrix[i][7][10],
				...
				ampTwoMod_five_active: data.data_matrix[i][4][11],
				ampTwoMod_six_active: data.data_matrix[i][5][11],
				ampTwoMod_seven_active: data.data_matrix[i][6][11],
				ampTwoMod_eight_active: data.data_matrix[i][7][11],
				...
				ampThreeMod_five_active: data.data_matrix[i][4][12],
				ampThreeMod_six_active: data.data_matrix[i][5][12],
				ampThreeMod_seven_active: data.data_matrix[i][6][12],
				ampThreeMod_eight_active: data.data_matrix[i][7][12],
				// Flux rate modulation (row 13)
				fluxRateMod_one_active: data.data_matrix[i][0][13],
				fluxRateMod_two_active: data.data_matrix[i][1][13],
				fluxRateMod_three_active: data.data_matrix[i][2][13],
				fluxRateMod_four_active: data.data_matrix[i][3][13],
				fluxRateMod_five_active: data.data_matrix[i][4][13],
				fluxRateMod_six_active: data.data_matrix[i][5][13],
				fluxRateMod_seven_active: data.data_matrix[i][6][13],
				fluxRateMod_eight_active: data.data_matrix[i][7][13],
				// Flux amount modulation (row 14)
				fluxAmtMod_one_active: data.data_matrix[i][0][14],
				fluxAmtMod_two_active: data.data_matrix[i][1][14],
				fluxAmtMod_three_active: data.data_matrix[i][2][14],
				fluxAmtMod_four_active: data.data_matrix[i][3][14],
				fluxAmtMod_five_active: data.data_matrix[i][4][14],
				fluxAmtMod_six_active: data.data_matrix[i][5][14],
				fluxAmtMod_seven_active: data.data_matrix[i][6][14],
				fluxAmtMod_eight_active: data.data_matrix[i][7][14],
				// FM ratio modulation (row 15)
				fmRatioMod_one_active: data.data_matrix[i][0][15],
				fmRatioMod_two_active: data.data_matrix[i][1][15],
				fmRatioMod_three_active: data.data_matrix[i][2][15],
				fmRatioMod_four_active: data.data_matrix[i][3][15],
				fmRatioMod_five_active: data.data_matrix[i][4][15],
				fmRatioMod_six_active: data.data_matrix[i][5][15],
				fmRatioMod_seven_active: data.data_matrix[i][6][15],
				fmRatioMod_eight_active: data.data_matrix[i][7][15],
				// FM amount modulation (row 16)
				fmAmtMod_one_active: data.data_matrix[i][0][16],
				fmAmtMod_two_active: data.data_matrix[i][1][16],
				fmAmtMod_three_active: data.data_matrix[i][2][16],
				fmAmtMod_four_active: data.data_matrix[i][3][16],
				fmAmtMod_five_active: data.data_matrix[i][4][16],
				fmAmtMod_six_active: data.data_matrix[i][5][16],
				fmAmtMod_seven_active: data.data_matrix[i][6][16],
				fmAmtMod_eight_active: data.data_matrix[i][7][16],
				// Phase modulation (row 17)
				phaseMod_one_active: data.data_matrix[i][0][17],
				phaseMod_two_active: data.data_matrix[i][1][17],
				phaseMod_three_active: data.data_matrix[i][2][17],
				phaseMod_four_active: data.data_matrix[i][3][17],
				phaseMod_five_active: data.data_matrix[i][4][17],
				phaseMod_six_active: data.data_matrix[i][5][17],
				phaseMod_seven_active: data.data_matrix[i][6][17],
				phaseMod_eight_active: data.data_matrix[i][7][17],
				// Offset modulation (rows 18-20)
				offset_1_one_active: data.data_matrix[i][0][18],
				offset_1_two_active: data.data_matrix[i][1][18],
				offset_1_three_active: data.data_matrix[i][2][18],
				offset_1_four_active: data.data_matrix[i][3][18],
				offset_1_five_active: data.data_matrix[i][4][18],
				offset_1_six_active: data.data_matrix[i][5][18],
				offset_1_seven_active: data.data_matrix[i][6][18],
				offset_1_eight_active: data.data_matrix[i][7][18],
				offset_2_one_active: data.data_matrix[i][0][19],
				offset_2_two_active: data.data_matrix[i][1][19],
				offset_2_three_active: data.data_matrix[i][2][19],
				offset_2_four_active: data.data_matrix[i][3][19],
				offset_2_five_active: data.data_matrix[i][4][19],
				offset_2_six_active: data.data_matrix[i][5][19],
				offset_2_seven_active: data.data_matrix[i][6][19],
				offset_2_eight_active: data.data_matrix[i][7][19],
				offset_3_one_active: data.data_matrix[i][0][20],
				offset_3_two_active: data.data_matrix[i][1][20],
				offset_3_three_active: data.data_matrix[i][2][20],
				offset_3_four_active: data.data_matrix[i][3][20],
				offset_3_five_active: data.data_matrix[i][4][20],
				offset_3_six_active: data.data_matrix[i][5][20],
				offset_3_seven_active: data.data_matrix[i][6][20],
				offset_3_eight_active: data.data_matrix[i][7][20],
				// Probability modulation (row 21)
				probabilityMod_one_active: data.data_matrix[i][0][21],
				probabilityMod_two_active: data.data_matrix[i][1][21],
				probabilityMod_three_active: data.data_matrix[i][2][21],
				probabilityMod_four_active: data.data_matrix[i][3][21],
				probabilityMod_five_active: data.data_matrix[i][4][21],
				probabilityMod_six_active: data.data_matrix[i][5][21],
				probabilityMod_seven_active: data.data_matrix[i][6][21],
				probabilityMod_eight_active: data.data_matrix[i][7][21]
			]);
		};
	}
